                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form class="form-reg" action="Controlador" method="POST">
                                    <h1 style="text-align: center">Registrar vendedor</h1>
                                    <br>
                                    <input type="number" placeholder="Cédula" name="txtCedulaV" value="${v.getCedula()}" required/><br><br>
                                    <input type="text" placeholder="Nombre" name="txtNombreV" value="${v.getNombre()}" required/><br><br>
                                    <input type="Apellidos" placeholder="Apellidos" name="txtApellidoV" value="${v.getApellido()}" required/><br><br>
                                    <input type="date" placeholder="Fecha Nacimiento" name="txtFNV" value="${fecha}" required/><br><br>      
                                    <input type="number" placeholder="Celular" name="txtCelularV" value="${v.getCelular()}"  required/><br><br>
                                    <input type="email" placeholder="Correo" name="txtCorreoV" value="${v.getCorreo()}" required/><br><br>
                                    <input type="text" placeholder="Zona Asignada" name="txtZonaV"  value="${v.getZona_asignada()}" required/><br><br>
                                    <input type="text" placeholder="Color -> Pregunta de seguridad" name="txtColorV" value="${v.getColor()}" required/><br><br>
                                    <br>
                                    <button class="nva-pag" type="submit" name="accion" value="registrarVendedor">Registrar</button>
                                </form>
                                <br>
                                </p>
                            </div>
                                ...
                                if (login === "OlvPassError") {
                                    ...
                                    if (login === "correoExist") {
                                        ...
                                        if (login === "cedulaExist") {
                                            swal({
                                                title: "Ups....",
                                                text: "Ya existe un vendedor registrado con esta cedula",
                                                icon: "error",
                                                button: "Continuar"
                                            });
                                        } else {
