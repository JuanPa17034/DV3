                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form class="form-reg" action="Controlador" method="POST">
                                    ...
                                    <br>
                                    <input type="number" placeholder="Id" name="txtIdEP" value="${p.getId_producto()}" disabled="" required/><br><br>
                                    <input type="text" placeholder="Codigo" name="txtCodigoEP" value="${p.getCodigo()}" required/><br><br>
                                    <input type="Apellidos" placeholder="Nombre" name="txtNombreEP" value="${p.getNombre()}" required/><br><br>
                                    <input type="text" placeholder="Descripcion" name="txtDescEP" value="${p.getDescripcion()}" required/><br><br>
                                    <input type="number" placeholder="Stock" name="txtStockEP" value="${p.getStock()}" required/><br><br>
                                    <input type="text" placeholder="Precio" name="txtPrecioEP" value="${p.getPrecio_venta()}" required/><br><br>
                                    <br>
                                    <button class="nva-pag atras" name="accion" value="cancelarP" type="submit">Cancelar</button>
