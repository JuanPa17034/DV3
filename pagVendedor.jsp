                            ...
                            <div class="card-body">
                                ...
                                <form action="Controlador" method="POST">
                                    <div class="search-box">
                                        <div class="search">
                                            <input class="searchPalabra" value="${buscar}" type="text" name="txtBuscarV" placeholder="Buscar">
                                            <button class="searchButton" name="accion" value="regresarBusquedaV" type="submit"><i class="fa fa-window-close" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
                                </form> 
                                <%                                                } else {
                                ...
                                <form action="Controlador" method="POST">
                                    <div class="search-box">
                                        <div class="search">
                                            <input class="searchPalabra" value="${buscar}" type="text" name="txtBuscarV" placeholder="Buscar" required >
                                            <button class="searchButton" name="accion" value="buscarVendedor" type="submit"><i class="fa fa-search"></i></button>
                                        </div>
                                    </div>
                                </form> 
                                <%                                    }
                                ...
                                <table border="2" class="content-table">
                                    ...
                                    <tbody>
                                        <c:forEach var="v" items="${listaVendedores}">
                                            <tr>
                                                <td>${v.getId_vendedor()}</td>
                                                <td>${v.getCedula()}</td>
                                                <td>${v.getNombre()}</td>
                                                <td>${v.getApellido()}</td>
                                                <td>${v.getCelular()}</td>
                                                <td>${v.getZona_asignada()}</td>
                                                <td>${v.getContrasena()}</td>
                                                <td>
                                                    <form action="#">
                                                        <input type="hidden" name="idvendedor" value="${v.getId_vendedor()}"/>
                                                        <button type="submit" class="btn-danger" name="accion" value="eliminarVe">&#x2716 Eliminar</button>
                                                        <button type="submit" class="btn-secondary" name="accion" value="pagEditarV">&#x2710 Editar</button>
                                                    </form> 
                                                </td>
                                            </tr>
                                        </c:forEach>
                                ...
                                <a type="submit" class="nva-pag" href="registroVendedor.jsp">&#x271a Añadir Vendedor</a>
                                </p>
                            </div>
                        </div>
