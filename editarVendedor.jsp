                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form class="form-reg" action="Controlador" method="POST">
                                    ...
                                    <br>
                                    <input type="number" placeholder="Cédula" name="txtCedulaEV" value="${v.getCedula()}" disabled="" required/><br><br>
                                    ...
                                    <input type="text" placeholder="Contraseña" name="txtContraEV" value="${v.getContrasena()}" required/><br><br>
