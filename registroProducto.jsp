                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form class="form-reg" action="Controlador" method="POST">
                                    ...
                                    <br>
                                    <input type="text" placeholder="Codigo" name="txtCodigoP" required/><br><br>
                                    <input type="text" placeholder="Nombre" name="txtNombreP" required/><br><br>
                                    <input type="Apellidos" placeholder="Descripción" name="txtDescP" required/><br><br>
                                    <input type="text" placeholder="Precio" name="txtPrecioP" required/><br><br>
                                    <input type="number" placeholder="Stock" name="txtStockP" required/><br><br>      
                                    <input type="file" name="imgFotoP" required/><br><br>
                                    <br>
